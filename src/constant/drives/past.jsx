const pastDrives = [
    ...
    {
        id: 2,
        title: "Pawlentine Drive",
        date: "February 16, 2025",
        location: "Jorhat Engineering College Road, Jorhat, Assam",
        description: (
            <div>
                <p>
                    Our Pawlentine Drive was a special initiative dedicated to
                    spreading love and care to our furry friends. On 16th
                    February 2025, we organized a vaccination and feeding drive
                    for stray dogs and cats in Jorhat. Our team collaborated
                    with Rajib Chakraborty Sir, local veterinarian Dr Laaraa
                    Ma'am and Nu Animal Walfare Foundation to provide essential
                    vaccinations and medical care to these animals.
                </p>
                <p>
                    In addition to medical assistance, we distributed food and
                    water to the stray dogs, ensuring they received proper
                    nutrition and hydration. This drive aimed to promote animal
                    welfare and create a safer and healthier environment for
